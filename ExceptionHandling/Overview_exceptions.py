...
29	.	ValueError	:	Raised when a function gets argument of correct type but improper value.
30	.	ZeroDivisionError	:	Raised when second operand of division or modulo operation is zero.
"""
